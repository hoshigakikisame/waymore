...
def processURLOutput():
    ...
    """
    global currentOutFile, splitOutputCount, linksFound, subs, path, argsInput, checkWayback, checkCommonCrawl, checkAlienVault, checkURLScan, checkVirusTotal, DEFAULT_OUTPUT_DIR, checkIntelx
